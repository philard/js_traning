...
(function() {
	...
	samples.instructions = { name: "Welcome", code: '//Press the button to visulaise the data structure.'


	};

	samples.classical = { name: "!!!Press here button to visulaise the data structure.!!!", code: 
