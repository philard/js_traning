...
(function() {
	...
	samples.instructions = { name: "Welcome", code: '//Press the !!!visualize!!! button to visualize the data structure.\n'+
		'// If you break it its your fault.\n'

	};

	samples.classical = { name: "!!!Press here button to visualize the data structure.!!!", code: '// -See bellow-\n' +
		'this.display=dispMe'

	};


	samples.inheritance = { name: "..", code: '// Parent class constructor\n' +
		'function Parent() {\n' +
		'  this.a = 42;\n' +
		'}\n' +
		'\n' +
	...
	samples.inception = { name: "..", code: 'this.jdls = jdls;\n' +
		'\n' +
