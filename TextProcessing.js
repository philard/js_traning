...
!function () {
    d3.longscroll = function () {
        function e(e) {
            function o(o) {
                e.each(function () {
                    ...
                    s.enter().append("div").attr("class", "row"), s.exit().remove(), s.order().call(textViewerRender)
                })
            }
        ...
        var textViewerRender = null,
          n = 0,
          r = 0,
          i = 20;
        return e.render = function (n) {
            return arguments.length ? (textViewerRender = n, e) : textViewerRender
